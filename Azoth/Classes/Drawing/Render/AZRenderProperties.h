...
extern NSString * const AZRendererTextureColourspace;
extern NSString * const AZRendererTextureHeadroom;
extern NSString * const AZRendererTextureWhitepoint;

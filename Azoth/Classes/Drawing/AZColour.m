...
static NSDictionary<NSString *,NSString *> *_colourmap =
	@{
	...
	@"control"				: @"166,166,166,255",
	@"selectedcontrol"		: @"242,242,242,255",
	@"selectedtext"			: @"0,0,0,255",
	@"text"					: @"0,0,0,255",
	@"controlbackground"	: @"242,242,242,255",
	@"grid"					: @"204,204,204,255",
	@"clear"				: @"0,0,0,0"
	};

static NSMutableDictionary * _usedColours = nil;
...
+ (AZColour *) colourWithFloatR:(float)r g:(float)g b:(float)b a:(float)a
	{
	return [[AZColour alloc] initWithFloatR:r g:g b:b a:a];
	}

/*****************************************************************************\
|* Return a colour by name
\*****************************************************************************/
+ (nullable AZColour *) colourNamed:(NSString *)name
	...
	dispatch_once(&onceToken,
		^{
		_usedColours = [NSMutableDictionary new];
		});

	/*************************************************************************\
	|* First see if we're done this one before, if so, return the create colour
	\*************************************************************************/
	NSString *key	 = name.lowercaseString;
	AZColour *colour = _usedColours[key];
	if (colour)
		return colour;
	...
	\*************************************************************************/
	NSString *recipe = _colourmap[key];
	if (recipe)
		{
		NSArray<NSString *> *values = [recipe componentsSeparatedByString:@","];
		if (values.count == 4)
			{
			colour = [AZColour colourWithByteR:values[0].intValue
											 g:values[1].intValue
											 b:values[2].intValue
											 a:values[3].intValue];
			_usedColours[key] = colour;
			}
		}
...
- (void) setRedAsFloat:(float)fVal
	{
	_R = (uint8_t)(255.f * fVal);
	}

- (void) setGreenAsFloat:(float)fVal
	{
	_G = (uint8_t)(255.f * fVal);
	}

- (void) setBlueAsFloat:(float)fVal
	{
	_B = (uint8_t)(255.f * fVal);
	}

- (void) setAlphaAsFloat:(float)fVal
	{
	_A = (uint8_t)(255.f * fVal);
	}
...
+ (AZColour *) grey12
	{
	return [self colourNamed:@"grey12"];
	}
...
+ (AZColour *) grey25
	{
	return [self colourNamed:@"grey25"];
	}
...
+ (AZColour *) grey37
	{
	return [self colourNamed:@"grey37"];
	}
...
+ (AZColour *) grey50
	{
	return [self colourNamed:@"grey50"];
	}
...
+ (AZColour *) grey75
	{
	return [self colourNamed:@"grey75"];
	}
...
+ (AZColour *) grey95
	{
	return [self colourNamed:@"grey95"];
	}
...
+ (AZColour *) magenta
	{
	return [self colourNamed:@"magenta"];
	}
...
+ (AZColour *) yellow
	{
	return [self colourNamed:@"yellow"];
	}
...
+ (AZColour *) orange
	{
	return [self colourNamed:@"orange"];
	}
...
+ (AZColour *) purple
	{
	return [self colourNamed:@"purple"];
	}
...
+ (AZColour *) control
	{
	return [self colourNamed:@"control"];
	}
...
+ (AZColour *) selectedControl
	{
	return [self colourNamed:@"selectedcontrol"];
	}
...
+ (AZColour *) selectedText
	{
	return [self colourNamed:@"selectedtext"];
	}
...
+ (AZColour *) controlBackground
	{
	return [self colourNamed:@"controlbackground"];
	}
...
+ (AZColour *) grid
	{
	return [self colourNamed:@"grid"];
	}


+ (NSArray<AZColour *> *) controlAlternatingRowBackgroundColours
	{
	return @[self.grey12, self.grey37];
	}
...
- (nonnull id)copyWithZone:(nullable NSZone *)zone
	{
	return [AZColour colourWithByteR:_R g:_G b:_B a:_A];
	}

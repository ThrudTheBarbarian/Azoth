...
\*****************************************************************************/
@protocol OLDAZTableViewDataSource <NSObject>
@optional
...
\*****************************************************************************/
@protocol OLDAZTableViewDelegate <NSObject>
@optional
...
@interface OLDAZTableView : AZControl
...
/*****************************************************************************\
|* Allow the table columns to repopulate the pool
\*****************************************************************************/
...
id<OLDAZTableViewDelegate>						delegate;

// The tableview datasource
@property(strong, nonatomic)
id<OLDAZTableViewDataSource>					dataSource;

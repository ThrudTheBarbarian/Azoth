...
// Disable the pool
@property(assign, nonatomic) BOOL							disablePool;
...
-(void)reloadData
	{
	// Tell the row to return any cached rows to the pool
	for (AZTableColumn *column in _tableColumns)
		[column returnCachedViewsToPool];
